...
import { Heartbreaking } from "discord-image-generation";
import ResponseUtil from "../../utils/ResponseUtil";

/**
 * @swagger
 * /generators/heartbreaking:
 *   get:
 *     summary: Generates a heartbreaking image
 *     tags: [Generators]
 *     parameters:
 *       - in: query
 *         name: image
...
export default async (req: Request, res: Response): Promise<any> => {
    try {
        ...
        const buffer = await new Heartbreaking().getImage(image as string);
