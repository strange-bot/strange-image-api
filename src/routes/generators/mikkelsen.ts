...
import { Mikkelsen } from "discord-image-generation";
import ResponseUtil from "../../utils/ResponseUtil";

/**
 * @swagger
 * /generators/mikkelsen:
 *   get:
 *     summary: Generates a mikkelsen meme
 *     tags: [Generators]
 *     parameters:
 *       - in: query
 *         name: image
...
export default async (req: Request, res: Response): Promise<any> => {
    try {
        ...
        const buffer = await new Mikkelsen().getImage(image as string);
